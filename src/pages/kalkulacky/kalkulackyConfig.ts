 ...
 */
const IVAN_WHATSAPP_E164 = "421902519328";
const IVAN_WHATSAPP_PREFILL_MESSAGE = "Ahoj, chcel by som sa poradiť.";
export const KALKULACKY_IVAN_WHATSAPP_HREF = `https://api.whatsapp.com/send?${new URLSearchParams({
  phone: IVAN_WHATSAPP_E164,
  text: IVAN_WHATSAPP_PREFILL_MESSAGE,
}).toString()}`;

export const KALKULACKY_KONZULTACIA_CARD = {
  title: "Chcem sa poradiť s Ivanom",
  description:
    "Napíš mi na WhatsApp a zisti, ako dokážeš svoje úspory pretaviť na doživotnú rentu.",
  href: KALKULACKY_IVAN_WHATSAPP_HREF,
} as const;
